package com.shantanubindhani.expensetracker.presentation.insight_screen

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.shantanubindhani.expensetracker.domain.model.Transaction
import com.shantanubindhani.expensetracker.domain.usecase.read_database.Get14DayTransaction
import com.shantanubindhani.expensetracker.domain.usecase.read_database.Get3DayTransaction
import com.shantanubindhani.expensetracker.domain.usecase.read_database.Get7DayTransaction
import com.shantanubindhani.expensetracker.domain.usecase.read_database.GetLastMonthTransaction
import com.shantanubindhani.expensetracker.domain.usecase.read_database.GetStartOfMonthTransaction
import com.shantanubindhani.expensetracker.domain.usecase.read_database.GetTransactionByTypeUseCase
import com.shantanubindhani.expensetracker.domain.usecase.read_datastore.GetCurrencyUseCase
import com.shantanubindhani.expensetracker.presentation.home_screen.TransactionType
