package com.shantanubindhani.expensetracker.presentation.home_screen

import androidx.compose.ui.graphics.Color
import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.shantanubindhani.expensetracker.R
import com.shantanubindhani.expensetracker.common.Constants
import com.shantanubindhani.expensetracker.data.local.entity.TransactionDto
import com.shantanubindhani.expensetracker.domain.model.Transaction
import com.shantanubindhani.expensetracker.domain.usecase.GetDateUseCase
import com.shantanubindhani.expensetracker.domain.usecase.GetFormattedDateUseCase
import com.shantanubindhani.expensetracker.domain.usecase.read_database.GetAccountUseCase
import com.shantanubindhani.expensetracker.domain.usecase.read_database.GetAccountsUseCase
import com.shantanubindhani.expensetracker.domain.usecase.read_database.GetAllTransactionUseCase
import com.shantanubindhani.expensetracker.domain.usecase.read_database.GetCurrentDayExpTransactionUseCase
import com.shantanubindhani.expensetracker.domain.usecase.read_database.GetDailyTransactionUseCase
import com.shantanubindhani.expensetracker.domain.usecase.read_database.GetMonthlyExpTransactionUse
import com.shantanubindhani.expensetracker.domain.usecase.read_database.GetWeeklyExpTransactionUseCase
import com.shantanubindhani.expensetracker.domain.usecase.read_datastore.GetCurrencyUseCase
import com.shantanubindhani.expensetracker.domain.usecase.read_datastore.GetExpenseLimitUseCase
import com.shantanubindhani.expensetracker.domain.usecase.read_datastore.GetLimitDurationUseCase
import com.shantanubindhani.expensetracker.domain.usecase.read_datastore.GetLimitKeyUseCase
import com.shantanubindhani.expensetracker.domain.usecase.write_database.InsertAccountsUseCase
import com.shantanubindhani.expensetracker.domain.usecase.write_database.InsertNewTransactionUseCase
import com.shantanubindhani.expensetracker.presentation.ui.theme.businessBg
import com.shantanubindhani.expensetracker.presentation.ui.theme.clothBg
import com.shantanubindhani.expensetracker.presentation.ui.theme.electricBg
import com.shantanubindhani.expensetracker.presentation.ui.theme.food_drink
import com.shantanubindhani.expensetracker.presentation.ui.theme.gadgetBg
import com.shantanubindhani.expensetracker.presentation.ui.theme.giftBg
import com.shantanubindhani.expensetracker.presentation.ui.theme.groceryBg
import com.shantanubindhani.expensetracker.presentation.ui.theme.healthBg
import com.shantanubindhani.expensetracker.presentation.ui.theme.homeBg
import com.shantanubindhani.expensetracker.presentation.ui.theme.leisureBg
import com.shantanubindhani.expensetracker.presentation.ui.theme.miscBg
import com.shantanubindhani.expensetracker.presentation.ui.theme.petBg
import com.shantanubindhani.expensetracker.presentation.ui.theme.schBg
import com.shantanubindhani.expensetracker.presentation.ui.theme.snackBg
import com.shantanubindhani.expensetracker.presentation.ui.theme.subBg
import com.shantanubindhani.expensetracker.presentation.ui.theme.taxiBg
import com.shantanubindhani.expensetracker.presentation.ui.theme.travelBg
import com.shantanubindhani.expensetracker.presentation.ui.theme.vehicleBg
